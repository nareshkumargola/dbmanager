...
export default function ConnectionMonitor() {
  ...
  const downloadMonitoringPDF = async () => {
    ...
    element.innerHTML = `
      <div style="display: flex; align-items: center; justify-content: space-between; border-bottom: 2px solid #0d9da4; padding-bottom: 14px; margin-bottom: 20px;">
        <div style="display: flex; align-items: center; gap: 12px;">
          <img src="/allatone_logo.jpg" style="height: 52px; width: auto; object-fit: contain; border-radius: 8px; border: 1px solid #e2e8f0; padding: 3px; background: #ffffff;" alt="Allatone Logo" />
          <div>
            <div style="font-size: 18px; font-weight: 800; color: #0d9da4; letter-spacing: 0.5px;">ALLATONE DMS</div>
            <div style="font-size: 9px; color: #64748b; font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px;">Enterprise Database Management &amp; Monitoring</div>
          </div>
        </div>
        <div style="text-align: right;">
          <div style="font-size: 15px; font-weight: bold; color: #0f172a;">${getTypeIcon(dbType)} Database Monitoring Report</div>
          <div style="font-size: 10px; color: #64748b; margin-top: 3px;">📅 Generated: ${new Date().toLocaleString('en-IN')}</div>
        </div>
      </div>
      ...
      <div style="margin-top: 30px; padding-top: 16px; border-top: 1.5px solid #cbd5e1; font-size: 10px; color: #64748b; display: flex; justify-content: space-between; align-items: center;">
        <div style="display: flex; align-items: center; gap: 8px;">
          <img src="/allatone_logo.jpg" style="height: 24px; width: auto; object-fit: contain; border-radius: 4px;" alt="Allatone Logo" />
          <span style="font-weight: bold; color: #0d9da4; font-size: 11px;">Allatone Database Management System (DMS)</span>
        </div>
        <div>Generated by Database Manager | ${new Date().toLocaleString('en-IN')}</div>
      </div>
    `;
