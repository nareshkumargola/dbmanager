        ...
        {user && (
          <button
            ...
            className={`p-2 rounded-xl border transition shadow-xs ${
              variant === 'teal'
                ? 'bg-teal-700/30 border-white/20 hover:bg-white/10 text-white'
                : 'bg-white border-gray-200 dark:bg-gray-800 dark:border-gray-700 text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700'
            }`}
