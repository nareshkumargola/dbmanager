        ...
        <div className="bg-white dark:bg-gray-850 border border-gray-200 dark:border-gray-800 rounded-xl p-6 shadow-xs leading-relaxed text-xs text-gray-650 dark:text-gray-300">
          ...
          {activeTab === 'privacy' && (
            <div className="space-y-4">
              ...
              <p>
                For auditing and tracking developer activities, we record the raw SQL/NoSQL command, database connection target, timestamp, and user ID of every query executed on our platform. These logs are preserved in read-only tables for safety audit purposes.
              </p>

              <h2 className="text-sm font-bold text-gray-900 dark:text-gray-100 mt-4">3. Data Sharing Restrictions</h2>
              <p>
                We do not sell, rent, lease, or distribute your identity details, database credentials, or query analytics data to any third-party marketing companies, advertisers, or vendors.
              </p>
            </div>
          )}
